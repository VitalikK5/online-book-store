...
import static com.example.bookhub.util.CategoryUtil.createListOfCategoryDtos;
import static com.example.bookhub.util.CategoryUtil.createUpdatedCategoryDto;
...
class CategoryControllerTest {
    ...
    void createCategory_validRequestDto_Success() throws Exception {
        CreateCategoryRequestDto requestDto = new CreateCategoryRequestDto()
                .setName("History")
                .setDescription("Books about history");
